...
var accordeonButton = document.querySelectorAll('.nav-site__acardeon-button');
var accordeonContent = document.querySelectorAll('.nav-site__acardeon-content');
var accNojs = document.querySelectorAll('.nav-site__accordeon-no-js');
function accordeonInit() {
  accNojs.forEach(function (item) {
