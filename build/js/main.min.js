...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_accordeon__WEBPACK_IMPORTED_MODULE_2__["initAccordion"])();
  ...
  window.addEventListener('load', function () {
    _modules_sroll__WEBPACK_IMPORTED_MODULE_4__["scrollTarget"].forEach(function (item) {
      if (item) {
        item.addEventListener('click', _modules_sroll__WEBPACK_IMPORTED_MODULE_4__["handleButtonclick"]);
      }
    });
  });
});
...
function initAccordion() {
  var accContent = document.querySelectorAll('.accordion__body');
  var accButtons = document.querySelectorAll('.accordion__btn');
...
var focusableElements = 'input, textarea, button, [tabindex]:not([tabindex="-1"])';
var firstFocusableElement = document.getElementById('name');
var focusableContent = modalWindow.querySelectorAll(focusableElements);
var lastFocusableElement = focusableContent[focusableContent.length - 1];
var textareaElement = focusableContent[focusableContent.length - 4];
var inputCheck = focusableContent[focusableContent.length - 2];
var buttonSubmit = focusableContent[focusableContent.length - 3];
function escClose() {
...
function focusable() {
  document.addEventListener('keydown', function (e) {
    var isTabPressed = e.key === 'Tab' || e.key === 9;
    if (!isTabPressed) {
      return;
    }
    if (e.shiftKey) {
...
var scrollTarget = document.querySelectorAll('.promo__button-decription');
