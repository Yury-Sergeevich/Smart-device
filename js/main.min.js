...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_accordeon__WEBPACK_IMPORTED_MODULE_2__["initAccordion"])(_modules_accordeon__WEBPACK_IMPORTED_MODULE_2__["accContent"]);
...
function initAccordion() {
  ...
  var navlinks = document.querySelectorAll('.accordion__btn');
  accContent.forEach(function (item) {
    return item.classList.remove('no-js');
  });
  function setTabindex() {
    navlinks.forEach(function (navlink) {
      return navlink.setAttribute('tabindex', '-1');
    });
  }
  function removeTabindex() {
    navlinks.forEach(function (navlink) {
      return navlink.removeAttribute('tabindex');
    });
  }
  if (screen.width < 768) {
    setTabindex();
